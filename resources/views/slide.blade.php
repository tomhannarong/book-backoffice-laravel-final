        ...
        $.ajax({
            ...
            success: (response) => {
                if ($.isEmptyObject(response.error)) {
                    ...
                    $('.modal-title').html("แก้ไขรูปภาพสไลด์");
