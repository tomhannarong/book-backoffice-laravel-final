 ...
 <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12 pt-2 pl-4">
                ...
                <li class="breadcrumb-item active">Add Webboard</li></ol>
            </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <div class="justify-content-center py-4">
        <div class="">
            ...
            <form id="theForm" action="{{ url('admin/board') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-middle">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 row" >
                                    <label for="" class="col-sm-4 col-md-4 col-lg-4 col-form-label">หัวข้อ</label>
                                        <div class="input-group col-sm-8 col-md-8 col-lg-8">
                                            <input class="form-control btn_rounded" type="text" id="topic" name="topic" >
                                        </div>
                                </div>
                            </div>
