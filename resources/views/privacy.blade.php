      ...
      <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12 pt-2 pl-4">
                ...
                <li class="breadcrumb-item active">Privacy</ol>
            </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-container">
                ...
                <form id="theForm" action="{{ url('admin/privacy') }}" method="POST" typeForm="" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="title">ชื่อหัวเรื่อง</label>
                            <input type="text" class="form-control btn_rounded" id="title" name="title" aria-describedby="title"
                                placeholder="ชื่อหัวเรื่อง">
                        </div>
                        <div class="form-group">
                            <label for="description">รายละเอียด</label>
                            <textarea id="description" name="description" class="btn_rounded"></textarea>
                        </div> 
        ...
        $.ajax({
            ...
            success: (response) => {
                if ($.isEmptyObject(response.error)) {
                    ...
                    $('#title').val(response.news_title);
                    $('#description').html("");
                    tinymce.activeEditor.setContent(response.news_detail);
                    tinyMCE.triggerSave();
    ...
    function datatableFilter() {
        table = $("#example").DataTable({
            ...
            columns: [{
                ...
                {
                    data: ({news_title}) => news_title ? `<strong class="text-color_main">${news_title}</strong>` : "-",
                    name: 'news_title'
                },
                {
                    data: 'public',
