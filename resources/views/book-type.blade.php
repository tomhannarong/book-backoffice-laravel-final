      ...
      <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12 pt-2 pl-4">
                ...
                <li class="breadcrumb-item active">Book Category</ol>
            </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-container">
                ...
                <form id="theForm" action="{{ url('admin/bookCategory') }}" method="POST" typeForm="">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" class="form-control btn_rounded" id="name" name="name" aria-describedby="name"
                                placeholder="ชื่อประเภทหนังสือ">
        ...
        $.ajax({
            ...
            success: (response) => {
                if ($.isEmptyObject(response.error)) {
                    ...
                    $('.modal-title').html("แก้ไขประเภทหนังสือ");
    ...
    function datatableFilter() {
        table = $("#example").DataTable({
            ...
            columns: [{
                ...
                {
                    data: ({book_type}) => book_type ? '<strong class="text-color_main">'+book_type+'</strong>' : "-",
                    name: 'book_type'
                },
                {
                    data: 'action',
