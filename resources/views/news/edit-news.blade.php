      ...
      <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12 pt-2 pl-4">
                ...
                <li class="breadcrumb-item active">Edit News</li></ol>
            </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="text-middle">                        
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 row">
                                <label for="head_news" class="col-sm-4 col-md-4 col-lg-4 col-form-label">หัวข้อข่าว</label>
                                <div class="input-group col-sm-8 col-md-8 col-lg-8">
                                <input class="form-control btn_rounded" type="text" id="head_news" name="head_news" value="{{ $news->head_news }}">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="btn_rounded">{{ $news->news_detail }}</textarea>
                        </div>      
                    </div>
                </div>
