      ...
      <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12 pt-2 pl-4">
                ...
                <li class="breadcrumb-item active">Payment</ol>
            </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-container">
                ...
                <form id="theForm" action="{{ url('admin/payment') }}" method="POST" typeForm="" enctype="multipart/form-data">
                    {{ csrf_field() }}
        ...
        $.ajax({
            ...
            success: (response) => {
                if ($.isEmptyObject(response.error)) {
                    ...
                    $('.modal-title').html("แก้ไขการจ่ายเงิน");
                    ...
                    $('#name').val(response.payment);
                    //$('#description').html("");
                    tinymce.activeEditor.setContent(response.payment_description);
                    tinyMCE.triggerSave();
    ...
    function datatableFilter() {
        table = $("#example").DataTable({
            ...
            columns: [{
                ...
                {
                    data: ({payment}) => payment ? `<strong class="text-color_main">${payment}</strong>` : "-",
                    name: 'payment'
                },
                {
                    data: 'action',
