                ...
                <div class="card" style="border:0">
                    ...
                    <div class="card-body ">
                        <div class="table-responsive">
                            <table id="example" class="table  table-fixed " style="width:100% ; text-align:center; ">
                            <thead>
                                <tr>
                                    <th>ลำดับที่</th>
                                    <th>รูปภาพ</th>
    ...
    function datatableFilter() {
        table = $("#example").DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: (data) => {
                        if(data.product_image){
                            ...
                            //  pic_test 
                            $html ='<img style="background-color: HoneyDew;" width="90" height="90" class="img-thumbnail " src="'+"{{ asset('storage/book-images') }}/"+data.product_image+'" >';                                                       
                ...
                {
                    data: (data) => {
                       var url = "{{ url('ebook/productsEbook/detail') }}/"+data.book_id ;
                            $html ='<a href="'+url+'" class="select_hover" style="text-shadow: 0 0 0.2em DeepSkyBlue"><h6>'+data.product_name+'</h6></a>';
                ...
                {
                    data: (data) =>{  
                        $html = '<s>'+data.alias_price+'</s> <b style="color:red">'+data.product_price+'</b>'
                        return $html ;
                      },
                    name: 'product_price'
                },
