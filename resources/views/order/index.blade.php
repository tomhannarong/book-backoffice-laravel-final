...
$(function() {
    ...
    $('body').on('click', '.submitEMS', function(e) {
        ...
        if(emsVal){
            ...
            Swal.fire({
                ...
                html: `<p>หมายเลขพัสดุ : <font class="color_ems_check">${emsVal}</font></p> 
                    <p>คุณตรวจสอบและยืนยันการทำรายการนี้</p>`, 
                icon: 'warning',
    ...
    $('body').on('click', '.btnRej', function() {
        ...
        var myArrayOfThings = [
            { id: 1, name: 'หลักฐานการโอนเงินไม่ถูกต้อง' },
            { id: 2, name: 'หลักฐานการโอนเงินไม่ครบถ้วน' },
            { id: 3, name: 'เหตุผลอื่นๆ' }
        ];
    ...
    $('body').on('change', '.swal2-select', function() {
        if($(this).val() === "เหตุผลอื่นๆ"){
            $("#swal_sendback_reason").html('<input id="swal_input_reason" class="swal2-input" placeholder="โปรดระบุเหตุผลอื่นๆ..">');
        }else{
    ...
    $('body').on('click', '.deleteBtn', function() {        
        ...
        Swal.fire({
            title: 'ยืนยันการยกเลิกการสั่งซื้อ?',
            text: "คุณตรวจสอบและยืนยันการทำรายการนี้",
            icon: 'danger',
            showCancelButton: true,
            confirmButtonColor: '#2DC8A8',
            ...
            if (result.value) {
                let reason = "ไม่ชำระเงินตามกำหนด";
                $.ajax({
                    type: "POST",
                    url: "{{ url('admin/order') }}" + '/' + Item_id,
            ...
            buttons: [
                ...
                <ul class="dropdown-menu dropdownOptionFiltersStyle">
                    ...
                    <li class="dropdownFiltersli">
                        ...
                        <input class="filtersCheck" type="checkbox" value="" id="filtersCheckSended"> <font class="">จัดส่งสินค้าเรียบร้อย</font></a>
                    </li>
                    <li class="dropdownFiltersli">
                    ...
                    <li class="dropdownFiltersli">
                        ...
                        <input class="filtersCheck" type="checkbox" value="" id="filtersCheckApprovedEbook"> <font class="">อนุมัติ E-Book</font></a>
                    </li>
                    <li class="dropdownFiltersli">
                        <a href="javascript:void(0)" class="checkboxFilters" data-val="filtersCheckCancelPeriod">
                        <input class="filtersCheck" type="checkbox" value="" id="filtersCheckCancelPeriod"> <font class="">คำสั่งซื้อหมดอายุ</font></a>
                    </li>
