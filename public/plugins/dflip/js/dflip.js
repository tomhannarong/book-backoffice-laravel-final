...
(function dFlip(DFLIP, $) {
    ...
    var defaults = DFLIP.defaults = {
        ...
        pdfjsSrc: window.location.origin+"/public/plugins/dflip/js/libs/pdf.min.js",
        //(NON-OPTION) source link for PDFcompatibility.JS file
        pdfjsCompatibilitySrc: window.location.origin+"/public/plugins/dflip/js/libs/compatibility.js",
        //(NON-OPTION) source link for PDF.WORKER.JS file
        pdfjsWorkerSrc: window.location.origin+"/public/plugins/dflip/js/libs/pdf.worker.min.js",
        //(NON-OPTION) source link for THREE.JS file
        threejsSrc: window.location.origin+"/public/plugins/dflip/js/libs/three.min.js",
        //(NON-OPTION) source link for MOCKUP.JS file
        mockupjsSrc: window.location.origin+"/public/plugins/dflip/js/libs/mockup.min.js",
        //(NON-OPTION) File path to the trun sound
        soundFile: window.location.origin+"/public/plugins/dflip/sound/turn2.mp3",
        imagesLocation: window.location.origin+"/public/plugins/dflip/images",
        imageResourcesPath: window.location.origin+"/public/plugins/dflip/images/pdfjs/",
                ...
                if (is3d) {
                    ...
                    target.wrapper.css({
                        ...
                        marginTop: (containerHeight - zoomHeight - paddingHeight) > 0 ?
                            (containerHeight - paddingHeight - zoomHeight) / 2 : 0
                    });
                    ...
                    if (basePage == 0 || isBooklet) {
                        ...
                        target.wrapper.css({
                            left: isSingle ?
                                ...
                                (isEven ? right - singleShift : left - singleShift) : 0
                        });
                        target.shadow.css({
                            width: '100%',
                            left: 0,
